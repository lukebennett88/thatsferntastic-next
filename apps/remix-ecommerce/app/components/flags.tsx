...
export function UnitedStatesFlag({ className }: { className: string }) {
  return (
    <svg className={className} viewBox="0 0 640 480" preserveAspectRatio="xMinYMin slice">
      <g fillRule="evenodd">
        <g strokeWidth="1pt">
          <path
            fill="#bd3d44"
...
export function MexicoFlag({ className }: { className: string }) {
  return (
    <svg className={className} preserveAspectRatio="xMinYMin slice" viewBox="0 0 640 480">
      <defs>
        <radialGradient
          id="b"
          cx="842.3"
