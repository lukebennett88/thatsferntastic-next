            ...
            <div className="mt-12 md:col-span-8 md:col-start-3 md:row-start-2 md:mt-0 lg:col-span-4 lg:col-start-9 lg:row-start-1">
              ...
              <div className="mt-12">
                ...
                <div className="mt-6 flex space-x-6">
                  <a href="https://www.facebook.com/thatsferntastic/" className="text-gray-400 hover:text-gray-500">
                    <span className="sr-only">Facebook</span>
                    <svg fill="currentColor" aria-hidden="true" viewBox="0 0 24 24" className="h-6 w-6">
                      <path
                        fillRule="evenodd"
                  ...
                  <a href="https://www.instagram.com/thatsferntastic/" className="text-gray-400 hover:text-gray-500">
                  ...
                  <a href="https://www.twitter.com/thatsferntastic/" className="text-gray-400 hover:text-gray-500">
