...
export const getServerSideProps: GetServerSideProps<ProductPageProps> = async ({
  ...
  try {
    const apolloClient = initialiseTsGql();
    ...
    <div className="bg-gray-50">
      ...
      <main>
        ...
        <div className="bg-white">
          <div className="max-w-2xl px-4 pt-16 pb-24 mx-auto sm:pt-24 sm:pb-32 sm:px-6 lg:max-w-7xl lg:px-8 lg:grid lg:grid-cols-2 lg:gap-x-8">
            {/* Product details */}
        ...
        <section aria-labelledby="reviews-heading" className="bg-white">
          <div className="max-w-2xl px-4 py-24 mx-auto sm:px-6 lg:max-w-7xl lg:py-32 lg:px-8 lg:grid lg:grid-cols-12 lg:gap-x-8">
