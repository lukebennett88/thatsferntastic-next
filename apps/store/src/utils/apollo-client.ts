...
function createApolloClient() {
  return new ApolloClient({
    ...
    link: new HttpLink({
      uri: `https://${process.env.NEXT_PUBLIC_SHOPIFY_STORE_DOMAIN}/api/${process.env.NEXT_PUBLIC_SHOPIFY_STOREFRONT_API_VERSION}/graphql.json`,
      headers: {
...
export function initialiseApollo(initialState = null): ApolloClient<NormalizedCacheObject> {
...
export const initialiseTsGql = initialiseApollo as (...args: Parameters<typeof initialiseApollo>) => Client;
