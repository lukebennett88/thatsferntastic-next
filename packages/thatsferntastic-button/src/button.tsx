import type { PolymorphicComponentPropsWithRef, PolymorphicRef, WithDisplayName } from "@thatsferntastic/polymorphic";
...
export function buttonClasses({ size = "lg", width = "auto", disabled }: ButtonClasses = {}): string {
  return classNames(
    sizeClasses(size),
    widthClasses(width),
...
type PolymorphicButtonProps<C extends React.ElementType> = PolymorphicComponentPropsWithRef<C, ButtonProps>;
...
export const Button: ButtonComponentWithDisplayName = React.forwardRef(
  <C extends React.ElementType = "button">(
    ...
    return (
      <Component ref={ref} className={buttonClasses({ size, width, disabled })} disabled={disabled} {...rest}>
        {children}
      </Component>
    );
  },
